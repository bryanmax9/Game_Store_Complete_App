...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public void configureGlobal(AuthenticationManagerBuilder auth, @Lazy PasswordEncoder encoder) throws Exception {
...
//    Here we will configure which endpoints a normal user can't acces and only admin users can
@Override
